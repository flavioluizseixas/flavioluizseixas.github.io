---
title: Introdução ao Aprendizado de Máquina para Saúde
code: TCC00367
...
objective: Capacitar estudantes a compreender, desenvolver, avaliar criticamente e comunicar soluções de aprendizado de máquina para problemas de saúde, considerando desempenho técnico, validade clínica, riscos, viabilidade de implementação, aspectos éticos e regulatórios e impacto no cuidado ao paciente.
syllabus:
...
methodology: Aulas integradas a seminários, análise de estudos de caso reais e desenvolvimento de um miniprojeto prático com bases como MIMIC-IV, PhysioNet, imagens públicas ou dados sintéticos quando houver restrição ética.
workload: 60 horas
credits: 4
prerequisites:
  - Estrutura de Dados
...
A disciplina introduz métodos de aprendizado de máquina e sua aplicação a dados e problemas da área da saúde, incluindo preparação de dados, construção de modelos e avaliação de resultados.

## Avaliação

O calendário de avaliações, atividades e apresentações será publicado após a confirmação do planejamento do semestre.
