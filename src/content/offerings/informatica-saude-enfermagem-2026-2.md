---
title: Informática em Saúde Aplicada à Enfermagem
code: A confirmar
slug: informatica-saude-enfermagem
term: '2026.2'
current: true
status: active
level: pos-graduacao
...
summary: Dados, sistemas e tecnologias digitais aplicados à pesquisa, à prática profissional, à decisão e aos produtos do Doutorado Profissional em Enfermagem.
...
Disciplina ministrada por Bianca Dargam Gomes Vieira e Flávio Luiz Seixas no Doutorado Profissional em Enfermagem.

## Avaliação

O plano prevê evidências cumulativas ao longo dos seis encontros e uma síntese final em formato de brief decisório e apresentação.
